...
/**
 * @event error
 * Emitted when an unexpected error occurs. The {@link #event-close close}
 * event will be emitted directly following this event.
 */
 ...
 * @param {boolean=true} options.enabled If the breakpoint is active or not.
